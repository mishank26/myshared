...
import cv2
cap = cv2.VideoCapture(0) #rtsp://(http://)208.139.200.133/

# This is needed since the notebook is stored in the object_detection folder.
import sys
import os
# run with enviornment variable "%tensorflow-test%"
HomePath = os.getcwd() #os.path.expanduser('~')
...
with detection_graph.as_default():
  od_graph_def = tf.GraphDef() # this is old code we need to upgrade this
